...
def probiou_loss(pred, target, eps=1e-3, mode='l1', cost=False):
    """
...
class ProbIoULoss(object):
    ...
    def __call__(self, pred_rboxes, assigned_rboxes, cost=False):
        return probiou_loss(pred_rboxes, assigned_rboxes, self.eps, self.mode, cost=cost)
