...
__all__ = ['DETRHead', 'DeformableDETRHead', 'DINOHead', 'MaskDINOHead', 'DINOHead_obb_Decoupled_Position',
           'DINOHead_Decoupled_Position']
...
@register
class DINOHead_obb_Decoupled_Position(nn.Layer):
    __inject__ = ['loss']

    def __init__(self, loss='DINOLoss_obb_Decoupled_Position'):
        super(DINOHead_obb_Decoupled_Position, self).__init__()
        self.loss = loss
    ...
    def forward(self, out_transformer, body_feats, inputs=None, infer = False):
        ...
        if self.training:
            ...
            assert 'gt_rbox_vis' in inputs and 'gt_class' in inputs
