...
__all__ = [
    ...
    'DETRPostProcess_obb_Decoupled_Position',
    'DETRPostProcess_Decoupled_Position'
]
...
@register
class DETRPostProcess_obb_Decoupled_Position(object):
    ...
    def __init__(self,
        ...
        super(DETRPostProcess_obb_Decoupled_Position, self).__init__()
